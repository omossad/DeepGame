...
static void updateDistanceCAVELambda() {
	...
	// PRINTING 
	block_ind = 0;
	ofstream MyFile("showROI.txt");
	for (unsigned int x = 0; x < heightDelta; x++) {
		for (unsigned int y = 0; y < widthDelta; y++) {
			MyFile << ROI[block_ind] << "  ";

			//cout << "WEIGHT " << x << " " << y << " : " << ROI[block_ind] << endl;
			block_ind++;
		}
		MyFile << endl;
	}
	...
	// PRINTING 
	block_ind = 0;
	ofstream MyFile2("showWEIGHT.txt");
	for (unsigned int x = 0; x < heightDelta; x++) {
		for (unsigned int y = 0; y < widthDelta; y++) {
			MyFile2 << weights[block_ind] << "  ";
			//cout << "WEIGHT " << x << " " << y << " : " << ROI[block_ind] << endl;
			block_ind++;
		}
		MyFile2 << endl;
	...
	// PRINTING 
	block_ind = 0;
	ofstream MyFile3("showWEIGHTFILTER.txt");
	for (unsigned int x = 0; x < heightDelta; x++) {
		for (unsigned int y = 0; y < widthDelta; y++) {
			MyFile3 << weights[block_ind] << "  ";
