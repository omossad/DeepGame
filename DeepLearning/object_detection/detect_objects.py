...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="C:\\Users\\omossad\\Desktop\\dataset\\model_data\\fifa\\selected_frames\\kh_0\\", help="path to dataset")
    ...
    dataloader = DataLoader(
        ImageFolder(opt.image_folder, img_size=img_size),
        batch_size=1,
        shuffle=False
    )
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        # Log progress
        print("\t Processing Image: %d" % (batch_i))
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        out_folder = 'C:\\Users\\omossad\\Desktop\\dataset\\objects\\'
        img_name = out_folder + img_name + '.jpg'
        ...
        if detections is not None:
            ...
            detections = rescale_boxes(detections, img_size, ((1080,1920)))
