### CODE TO CALCULATE SALIENCY METRICS ###
# source: https://raw.githubusercontent.com/tarunsharma1/saliency_metrics/master/salience_metrics.py #
...
gt = cv2.imread('C:\\Users\\omossad\\Desktop\\salicon\\maps\\test\\COCO_test2014_000000000219.png',0)
#d_gt = np.zeros(gt.shape)
#d_gt[gt>0]=1.0


s_map = cv2.imread('C:\\Users\\omossad\\Desktop\\salicon\\maps\\test\\COCO_test2014_000000000627.png',0)
#s_map, gt = generate_dummy()
