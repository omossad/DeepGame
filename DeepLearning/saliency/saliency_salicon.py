...
print ("Total Train Images: {}".format(len(os.listdir(base_dir + 'images\\train\\'))))
print ("Total Valid Images: {}".format(len(os.listdir(base_dir + 'images\\val\\'))))
print ("Total Test  Images: {}".format(len(os.listdir(base_dir + 'images\\test\\'))))
...
imgs_train_path = base_dir + 'images\\train\\'
maps_train_path = base_dir + 'maps\\train\\'
...
test_file = [ f for f in os.listdir(base_dir + 'images\\test\\') if f.endswith('.jpg') ]

for i in test_file:
    img = preprocess_images([base_dir + 'images\\test\\'+i],shape_r,shape_c)
